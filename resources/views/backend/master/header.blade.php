        ...
        <div class="d-none d-lg-flex align-items-center mr-3">
            ...
            <button class="btn btn-icon aside-toggle ml-n3 mr-10" id="kt_aside_desktop_toggle">
                <span class="svg-icon svg-icon-xxl svg-icon-dark-75">
                    <!--begin::Svg Icon | path:backend/assets/media/svg/icons/Text/Align-left.svg-->
            ...
            <!--begin::Logo-->
            <a href="index.html">
                <img alt="Logo" src="backend/assets/media/logos/logo-letter-1.png" class="logo-sticky max-h-35px" />
            </a>
            <!--end::Logo-->
                        ...
                        <div class="input-group-prepend">
                            <span class="input-group-text">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:backend/assets/media/svg/icons/General/Search.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24" />
